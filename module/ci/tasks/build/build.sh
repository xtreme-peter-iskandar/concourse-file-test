...
processFile $OKTA_XML_1_BASE64_DATA $OKTA_XML_1_ORIGINAL_FILENAME $OKTA_XML_1_BASE64_SHA1 $OKTA_XML_1_ORIGINAL_SHA1

processFile $OKTA_XML_2_BASE64_DATA $OKTA_XML_2_ORIGINAL_FILENAME $OKTA_XML_2_BASE64_SHA1 $OKTA_XML_2_ORIGINAL_SHA1

processFile $OKTA_XML_3_BASE64_DATA $OKTA_XML_3_ORIGINAL_FILENAME $OKTA_XML_3_BASE64_SHA1 $OKTA_XML_3_ORIGINAL_SHA1

processFile $SFDC_CERTS_SFDC_BASE64_DATA $SFDC_CERTS_SFDC_ORIGINAL_FILENAME $SFDC_CERTS_SFDC_BASE64_SHA1 $SFDC_CERTS_SFDC_ORIGINAL_SHA1

processFile $SFDC_CERTS_SFDC_PROD_BASE64_DATA $SFDC_CERTS_SFDC_PROD_ORIGINAL_FILENAME $SFDC_CERTS_SFDC_PROD_BASE64_SHA1 $SFDC_CERTS_SFDC_PROD_ORIGINAL_SHA1

processFile $SFDC_CERTS_SFDC_SANDBOX_BASE64_DATA $SFDC_CERTS_SFDC_SANDBOX_ORIGINAL_FILENAME $SFDC_CERTS_SFDC_SANDBOX_BASE64_SHA1 $SFDC_CERTS_SFDC_SANDBOX_ORIGINAL_SHA1
